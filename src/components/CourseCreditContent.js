...
import { ExternalLink, Coffee, Lightbulb } from 'lucide-react';
...
// Shared course-credit and support content used by both the first-run
// WelcomeDialog and the Settings -> About tab. Kept in one place so the
// instructor bio, links, and donate buttons stay in sync.
function CourseCreditContent() {
  return (
    <>
      <p className="text-base leading-relaxed text-foreground m-0">
        This application is built around the excellent{' '}
        <strong className="text-primary font-semibold">CCNA 200-301 Complete Course</strong> created
        by <strong className="text-primary font-semibold">Jeremy McDowell</strong> of Jeremy&apos;s
        IT Lab.
      </p>
      ...
      <div className="bg-card border border-border rounded-xl p-5 transition-all hover:shadow-[0_2px_8px_hsl(var(--foreground)/0.08)]">
        ...
        <p className="m-0 leading-relaxed text-muted-foreground">
          ...
          YouTube channel and various platforms. His CCNA course is widely recognized as one of the
          best free resources available for CCNA certification preparation.
        </p>
      </div>
      ...
      <div className="bg-card border border-border rounded-xl p-5 border-l-4 border-l-[var(--color-confidence-okay,#ffc107)] transition-all hover:shadow-[0_2px_8px_hsl(var(--foreground)/0.08)]">
        ...
        <p className="m-0 mb-3 leading-relaxed text-muted-foreground">
          ...
          study CCNA meant opening my browser, navigating through playlists, and inevitably getting
          distracted by YouTube&apos;s engagement machine. One moment I&apos;m learning OSPF, next
          I&apos;m watching &apos;Top 10 Anime Fights&apos; or &apos;How to Be 10x More
          Productive.&apos;
        </p>
        <p className="m-0 leading-relaxed text-muted-foreground">
      ...
      <div className="bg-card border border-border rounded-xl p-5 transition-all hover:shadow-[0_2px_8px_hsl(var(--foreground)/0.08)]">
        ...
        <p className="m-0 mb-3 leading-relaxed text-muted-foreground">
          Jeremy provides excellent free networking education. Consider supporting his work through
          his platforms:
        </p>
...
export default CourseCreditContent;
